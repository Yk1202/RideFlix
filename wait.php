...
<html lang="en">
<head>
	<title>RideFlix Car Rental</title>
	<meta charset="utf-8">
	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				<h2 style="text-align:center; color:#FF0000; font-family: 'Courier New', Courier, monospace">Thank you for sending a request to RideFlix Rescue Team. 
	...
	<footer>
		<div class="wrapper footer">
			<ul>
				...
				<li class="about">
					<p>RideFlix Rescue team is an organized company that rents cars and other vehicles to clients at lower costs.</p>
					<ul>
		...
		<div class="copyrights wrapper">
			Copyright &copy; <?php echo date("Y")?> All Rights Reserved | Designed by RideFlix.
		</div>
	</footer><!--  end footer  -->
